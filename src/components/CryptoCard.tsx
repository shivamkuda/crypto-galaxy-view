...
const CryptoCard: React.FC<CryptoCardProps> = ({ trending, trendingRank }) => {
  ...
  return (
    <Link to={`/crypto/${trending.item.id}`} className="block">
      <div className="crypto-card p-4 relative overflow-hidden animate-slide-up" style={{ animationDelay: `${trendingRank * 100}ms` }}>
        ...
        <div className="flex items-center gap-3 mb-3">
          ...
          />
          <div>
            <h3 className="font-bold">{trending.item.name}</h3>
